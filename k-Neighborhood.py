...
class TemporalGraph:
    ...
    def total_reachability_after(self, deleted_node, a, b, k):
        total = 0
        subgraph = self.k_neighborhood2(deleted_node, k)
        ...
        for node in subgraph:
            ...
            reach_set = {node}
            visited = set()
            earliest_arrival_time = {c: np.inf for c in subgraph}
...
if __name__ == '__main__':
    ...
    output_file = input_graph.split(".")[0] + '-k-Nachbarschaft-Ranking-Test' + '.txt'
    G = TemporalGraph()
