...
if __name__ == '__main__':
    ...
    # ia-reality-call.txt                   |  |V| = 6.809   | |E| = 52.050     307.1 min | 343.0 min | 107.3 min --> geloeschte Knoten Anzahl 3209
    ...
    # email-dnc.txt                         |  |V| = 1.891   | |E| = 39.264     67.23 min | 66.62 min | 26.14 min --> gelöschte Knoten Anzahl: 912
    # copresence-InVS15.txt                 |  |V| = 219     | |E| = 1.283.194  11.76 min |       min | 31.32 min --> gelöschte Knoten Anzahl 2
    # fb-forum.txt                          |  |V| = 899     | |E| = 33.720     9.164 min | 12.03 min | 12.04 min --> gelöschte Knoten Anzahl: 0
    # tij_SFHH.txt                          |  |V| = 403     | |E| = 70.261     5.790 min | 10.63 min | 10.23 min --> gelöschte Knoten Anzahl: 7
    # ht09_contact_list.txt                 |  |V| = 5.351   | |E| = 20.817     2.727 min | 2.701 min | 0.0005 min --> gelöschte Knoten Anzahl: Alle
